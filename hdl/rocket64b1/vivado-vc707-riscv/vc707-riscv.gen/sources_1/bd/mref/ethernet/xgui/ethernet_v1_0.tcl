...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "pkt_ptr_bits" -parent ${Page_0}
...
proc update_PARAM_VALUE.pkt_ptr_bits { PARAM_VALUE.pkt_ptr_bits } {
	# Procedure called to update pkt_ptr_bits when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.pkt_ptr_bits { PARAM_VALUE.pkt_ptr_bits } {
	# Procedure called to validate pkt_ptr_bits
	return true
}
...
proc update_MODELPARAM_VALUE.pkt_ptr_bits { MODELPARAM_VALUE.pkt_ptr_bits PARAM_VALUE.pkt_ptr_bits } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.pkt_ptr_bits}] ${MODELPARAM_VALUE.pkt_ptr_bits}
}
