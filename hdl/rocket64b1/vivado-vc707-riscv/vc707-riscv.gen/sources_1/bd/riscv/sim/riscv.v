...
module EthernetVC707_imp_1RFHSR3
   (RX_AXIS_tdata,
    RX_AXIS_tkeep,
    RX_AXIS_tlast,
    RX_AXIS_tready,
  ...
  wire Ethernet_SGMII_Clock_CLK_N;
  wire Ethernet_SGMII_Clock_CLK_P;
  wire Ethernet_SGMII_RXN;
  wire Ethernet_SGMII_RXP;
  wire Ethernet_SGMII_TXN;
  wire Ethernet_SGMII_TXP;
  ...
  wire Ethernet_reset;
  wire [7:0]ethernet_stream_0_GMII_RXD;
  wire ethernet_stream_0_GMII_RX_DV;
  wire ethernet_stream_0_GMII_RX_ER;
  wire [7:0]ethernet_stream_0_GMII_TXD;
  wire ethernet_stream_0_GMII_TX_EN;
  wire ethernet_stream_0_GMII_TX_ER;
  ...
  wire [15:0]ethernet_stream_0_an_adv_config_vector;
  wire ethernet_stream_0_an_restart_config;
  wire ethernet_stream_0_clock;
  wire [4:0]ethernet_stream_0_configuration_vector;
  wire ethernet_stream_0_signal_detect;
  wire ethernet_stream_0_speed_is_100;
  wire ethernet_stream_0_speed_is_10_100;
  wire gig_ethernet_pcs_pma_0_an_interrupt;
  wire gig_ethernet_pcs_pma_0_gmii_isolate;
  wire gig_ethernet_pcs_pma_0_mmcm_locked_out;
  wire gig_ethernet_pcs_pma_0_sgmii_clk_en;
  wire gig_ethernet_pcs_pma_0_sgmii_clk_f;
  wire gig_ethernet_pcs_pma_0_sgmii_clk_r;
  wire [15:0]gig_ethernet_pcs_pma_0_status_vector;
  wire gig_ethernet_pcs_pma_0_userclk2_out;
  wire gig_ethernet_pcs_pma_0_userclk_out;
  wire independent_clock_bufg_1;
  wire sys_reset;

  assign Ethernet_SGMII_Clock_CLK_N = sgmii_mgt_clk_clk_n;
  assign Ethernet_SGMII_Clock_CLK_P = sgmii_mgt_clk_clk_p;
  assign Ethernet_SGMII_RXN = sgmii_rxn;
  assign Ethernet_SGMII_RXP = sgmii_rxp;
  assign Ethernet_TX_AXIS_TDATA = TX_AXIS_tdata[7:0];
  assign Ethernet_TX_AXIS_TKEEP = TX_AXIS_tkeep[0];
  assign Ethernet_TX_AXIS_TLAST = TX_AXIS_tlast;
  assign Ethernet_TX_AXIS_TUSER = TX_AXIS_tuser;
  assign Ethernet_TX_AXIS_TVALID = TX_AXIS_tvalid;
  assign Ethernet_reset = reset;
  assign RX_AXIS_tdata[7:0] = ethernet_stream_0_RX_AXIS_TDATA;
  assign RX_AXIS_tkeep[0] = ethernet_stream_0_RX_AXIS_TKEEP;
  assign RX_AXIS_tlast = ethernet_stream_0_RX_AXIS_TLAST;
  assign RX_AXIS_tuser = ethernet_stream_0_RX_AXIS_TUSER;
  assign RX_AXIS_tvalid = ethernet_stream_0_RX_AXIS_TVALID;
  assign TX_AXIS_tready = Ethernet_TX_AXIS_TREADY;
  assign clock = ethernet_stream_0_clock;
  assign ethernet_stream_0_RX_AXIS_TREADY = RX_AXIS_tready;
  assign independent_clock_bufg_1 = clock_200Mhz;
  assign mmcm_locked = gig_ethernet_pcs_pma_0_mmcm_locked_out;
  assign sgmii_txn = Ethernet_SGMII_TXN;
  assign sgmii_txp = Ethernet_SGMII_TXP;
  assign status_vector[15:0] = gig_ethernet_pcs_pma_0_status_vector;
  riscv_ethernet_stream_0_0 ethernet_stream_0
       (.an_adv_config_vector(ethernet_stream_0_an_adv_config_vector),
        .an_interrupt(gig_ethernet_pcs_pma_0_an_interrupt),
        .an_restart_config(ethernet_stream_0_an_restart_config),
        .clock(ethernet_stream_0_clock),
        .configuration_vector(ethernet_stream_0_configuration_vector),
        .gmii_isolate(gig_ethernet_pcs_pma_0_gmii_isolate),
        .gmii_rx_dv(ethernet_stream_0_GMII_RX_DV),
        .gmii_rx_er(ethernet_stream_0_GMII_RX_ER),
        .gmii_rxd(ethernet_stream_0_GMII_RXD),
        .gmii_tx_en(ethernet_stream_0_GMII_TX_EN),
        .gmii_tx_er(ethernet_stream_0_GMII_TX_ER),
        .gmii_txd(ethernet_stream_0_GMII_TXD),
        ...
        .sgmii_clk_en(gig_ethernet_pcs_pma_0_sgmii_clk_en),
        .sgmii_clk_f(gig_ethernet_pcs_pma_0_sgmii_clk_f),
        .sgmii_clk_r(gig_ethernet_pcs_pma_0_sgmii_clk_r),
        .signal_detect(ethernet_stream_0_signal_detect),
        .speed_is_100(ethernet_stream_0_speed_is_100),
        .speed_is_10_100(ethernet_stream_0_speed_is_10_100),
        ...
        .userclk_out(gig_ethernet_pcs_pma_0_userclk_out));
  riscv_gig_ethernet_pcs_pma_0_0 gig_ethernet_pcs_pma_0
       (.an_adv_config_vector(ethernet_stream_0_an_adv_config_vector),
        .an_interrupt(gig_ethernet_pcs_pma_0_an_interrupt),
        .an_restart_config(ethernet_stream_0_an_restart_config),
        .configuration_vector(ethernet_stream_0_configuration_vector),
        ...
        .gmii_tx_er(ethernet_stream_0_GMII_TX_ER),
        .gmii_txd(ethernet_stream_0_GMII_TXD),
        .gtrefclk_n(Ethernet_SGMII_Clock_CLK_N),
        .gtrefclk_p(Ethernet_SGMII_Clock_CLK_P),
        .independent_clock_bufg(independent_clock_bufg_1),
        .mmcm_locked_out(gig_ethernet_pcs_pma_0_mmcm_locked_out),
        .reset(sys_reset),
        .rxn(Ethernet_SGMII_RXN),
        .rxp(Ethernet_SGMII_RXP),
        .sgmii_clk_en(gig_ethernet_pcs_pma_0_sgmii_clk_en),
        .sgmii_clk_f(gig_ethernet_pcs_pma_0_sgmii_clk_f),
        .sgmii_clk_r(gig_ethernet_pcs_pma_0_sgmii_clk_r),
        .signal_detect(ethernet_stream_0_signal_detect),
        ...
        .speed_is_10_100(ethernet_stream_0_speed_is_10_100),
        .status_vector(gig_ethernet_pcs_pma_0_status_vector),
        .txn(Ethernet_SGMII_TXN),
        .txp(Ethernet_SGMII_TXP),
        .userclk2_out(gig_ethernet_pcs_pma_0_userclk2_out),
        .userclk_out(gig_ethernet_pcs_pma_0_userclk_out));
endmodule
...
module IO_imp_44488Y
  ...
  assign mmcm_locked = Ethernet_mmcm_locked;
  ...
  riscv_Ethernet_0 Ethernet
       (.async_resetn(AXI_reset),
        ...
        .status_vector(Ethernet_status_vector),
        .tx_axis_tdata(Ethernet_TX_AXIS_TDATA),
        .tx_axis_tkeep(Ethernet_TX_AXIS_TKEEP),
        .tx_axis_tlast(Ethernet_TX_AXIS_TLAST),
        .tx_axis_tready(Ethernet_TX_AXIS_TREADY),
        .tx_axis_tuser(Ethernet_TX_AXIS_TUSER),
        .tx_axis_tvalid(Ethernet_TX_AXIS_TVALID));
  EthernetVC707_imp_1RFHSR3 EthernetVC707
       (.RX_AXIS_tdata(ethernet_stream_0_RX_AXIS_TDATA),
        .RX_AXIS_tkeep(ethernet_stream_0_RX_AXIS_TKEEP),
        .RX_AXIS_tlast(ethernet_stream_0_RX_AXIS_TLAST),
        .RX_AXIS_tready(ethernet_stream_0_RX_AXIS_TREADY),
        ...
        .mmcm_locked(Ethernet_mmcm_locked),
        .reset(Ethernet_reset),
        .sgmii_mgt_clk_clk_n(Ethernet_SGMII_Clock_CLK_N),
        .sgmii_mgt_clk_clk_p(Ethernet_SGMII_Clock_CLK_P),
        .sgmii_rxn(Ethernet_SGMII_RXN),
        .sgmii_rxp(Ethernet_SGMII_RXP),
        .sgmii_txn(Ethernet_SGMII_TXN),
        .sgmii_txp(Ethernet_SGMII_TXP),
        .status_vector(Ethernet_status_vector),
        .sys_reset(sys_reset));
  riscv_SD_0 SD
       (.async_resetn(AXI_reset),
...
(* CORE_GENERATION_INFO = "riscv,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=riscv,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=18,numReposBlks=15,numNonXlnxBlks=0,numHierBlks=3,maxHierDepth=2,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "riscv.hwdef" *) 
module riscv
   (DDR3_0_addr,
    DDR3_0_ba,
    DDR3_0_cas_n,
  ...
  inout sdio_cmd;
  inout [3:0]sdio_dat;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 sgmii_mgt_clk CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME sgmii_mgt_clk, CAN_DEBUG false, FREQ_HZ 125000000" *) input sgmii_mgt_clk_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 sgmii_mgt_clk CLK_P" *) input sgmii_mgt_clk_clk_p;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 sys_diff_clock CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME sys_diff_clock, CAN_DEBUG false, FREQ_HZ 200000000" *) input [0:0]sys_diff_clock_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 sys_diff_clock CLK_P" *) input [0:0]sys_diff_clock_clk_p;
  ...
  assign IO_sgmii_0_RXN = sgmii_rxn;
  assign IO_sgmii_0_RXP = sgmii_rxp;
  ...
  assign sgmii_mgt_clk_CLK_N = sgmii_mgt_clk_clk_n;
  assign sgmii_mgt_clk_CLK_P = sgmii_mgt_clk_clk_p;
  assign sgmii_txn = IO_sgmii_0_TXN;
  assign sgmii_txp = IO_sgmii_0_TXP;
  assign sys_diff_clock_CLK_N = sys_diff_clock_clk_n[0];
  assign sys_diff_clock_CLK_P = sys_diff_clock_clk_p[0];
  assign sys_reset = reset;
  DDR_imp_10J4PB3 DDR
       (.DDR3_0_addr(mig_7series_0_DDR3_ADDR),
        .DDR3_0_ba(mig_7series_0_DDR3_BA),
        .DDR3_0_cas_n(mig_7series_0_DDR3_CAS_N),
        .DDR3_0_ck_n(mig_7series_0_DDR3_CK_N),
        .DDR3_0_ck_p(mig_7series_0_DDR3_CK_P),
        .DDR3_0_cke(mig_7series_0_DDR3_CKE),
        .DDR3_0_cs_n(mig_7series_0_DDR3_CS_N),
        .DDR3_0_dm(mig_7series_0_DDR3_DM),
        .DDR3_0_dq(DDR3_0_dq[63:0]),
        .DDR3_0_dqs_n(DDR3_0_dqs_n[7:0]),
        .DDR3_0_dqs_p(DDR3_0_dqs_p[7:0]),
        .DDR3_0_odt(mig_7series_0_DDR3_ODT),
  ...
  IO_imp_44488Y IO
       (.M00_AXI_araddr(io_axi_m_ARADDR),
        ...
        .sgmii_rxn(IO_sgmii_0_RXN),
        .sgmii_rxp(IO_sgmii_0_RXP),
        .sgmii_txn(IO_sgmii_0_TXN),
        .sgmii_txp(IO_sgmii_0_TXP),
        .sys_reset(sys_reset),
  ...
  riscv_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(sys_clock),
        ...
        .locked(clock_ok));
  riscv_sys_diff_clock_buf_0 sys_diff_clock_buf
